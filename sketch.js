...
function Wave(theta, y_off, stroke_color, stroke_opaque, grad_dir){
    ...
    var stroke_color = stroke_color || [100, 200, 200];
    var stroke_width = 3;
    var grad_dir = grad_dir || -1;
    var stroke_opaque = stroke_opaque || 70;
    
    var theta = theta || random(50, 90);
...
//      console.log(theta, y_off);
        ...
        amplitude[0] = waves_param[0].amp ? waves_param[0].amp : random(10,25);
        var period = waves_param[0].period ? waves_param[0].period : random(800,1500); // Num pixels before wave repeats
